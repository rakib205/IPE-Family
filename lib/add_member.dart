...
void checkExist (){
 ...
 reference.child('All User').once().then((DataSnapshot snap){
   ...
   if(keys.contains(regNo)){
     print('yes');
     alertMessage = 'This member is already exist';
     showDialogs();
   }
   else{
     print('no');
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Add New Member',style: TextStyle(
              fontFamily: "Raleway",
                    ...
                    child: TextFormField(
                      ...
                      controller: companyCtrl,
                        decoration: InputDecoration(
                            ...
                            //prefixIcon: Icon(Icons.insert_link),
                            suffixIcon: IconButton(
                              icon: Icon(FontAwesomeIcons.warehouse,size: 16,),
                              onPressed: () {
                                companyCtrl.clear();
                              },
                            )),
